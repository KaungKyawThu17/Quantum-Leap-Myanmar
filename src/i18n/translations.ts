...
export const translations = {
  en: {
    ...
    "contact.form.error":
      "We couldn't send your message. Please email cs@quantumleap-mm.com directly.",
    ...
    "contact.service.oem": "OEM and ODM Manufacturing",
  ...
  my: {
    ...
    "contact.hero.title": "Quantum Leap ဖြင့် သင့်ရဲ့အဖျော်ယမကာအမှတ်တံဆိပ်ကို စတင်လိုက်ပါ",
    "contact.hero.subtitle":
    ...
    "contact.card.company.line1":
      "ရန်ကုန်အခြေစိုက် မျိုးဆက်သစ် OEM နှင့် ODM အဖျော်ယမကာ ထုတ်လုပ်သူ။",

    "contact.card.visit.title": "လိပ်စာ",
    ...
    "contact.card.visit.line4": "မင်္ဂလာဒုံမြို့နယ်၊ ရန်ကုန်မြို့။",

    "contact.card.call.title": "ဖုန်းခေါ်ဆိုရန်",
    "contact.card.email.title": "အီးမေးလ်",

    "contact.form.title": "သတင်းစကား ပေးပို့ပါ",
    "contact.form.subtitle": "စီးပွားရေးဆိုင်ရာ စုံစမ်းမှုများကို ကျွန်ုပ်တို့အဖွဲ့မှ ပြန်လည်ဆက်သွယ်ပါမည်။",
    "contact.form.thanks":
      "ကျေးဇူးတင်ပါသည် — သင်၏သတင်းစကားကို လက်ခံရရှိပါပြီ။ ကျွန်ုပ်တို့အဖွဲ့မှ မကြာမီ ဆက်သွယ်ပါမည်။",
    "contact.form.error":
      "သတင်းစကား ပေးပို့၍မရပါ။ cs@quantumleap-mm.com သို့ တိုက်ရိုက် အီးမေးလ်ပို့ပါ။",
    ...
    "contact.form.sending": "ပေးပို့နေသည်...",

    "contact.service.oem": "OEM နှင့် ODM ထုတ်လုပ်မှု",
